 ...
 * ```
 */
export function getLines(opts?: pulumi.InvokeOptions): Promise<GetLinesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("splight:index/getLines:getLines", {
    }, opts);
}
...
export interface GetLinesResult {
     ...
     */
    readonly id: string;
    readonly tags: outputs.GetLinesTag[];
}
/**
 * ## Example Usage
 *
