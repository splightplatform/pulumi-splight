 ...
 * ```
 */
export class DashboardAlertlistChart extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DashboardAlertlistChartState, opts?: pulumi.CustomResourceOptions): DashboardAlertlistChart {
        return new DashboardAlertlistChart(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'splight:index/dashboardAlertlistChart:DashboardAlertlistChart';

    /**
     * Returns true if the given object is an instance of DashboardAlertlistChart.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DashboardAlertlistChart {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DashboardAlertlistChart.__pulumiType;
    }

    /**
     * alert list type
     */
    public readonly alertListType!: pulumi.Output<string | undefined>;
    /**
     * chart traces to be included
     */
    public readonly chartItems!: pulumi.Output<outputs.DashboardAlertlistChartChartItem[]>;
     ...
     * filter status list
     */
    public readonly filterStatuses!: pulumi.Output<string[] | undefined>;
    /**
     * chart height in px
     */
     ...
     */
    public readonly thresholds!: pulumi.Output<outputs.DashboardAlertlistChartThreshold[] | undefined>;
    /**
     ...
     */
    public readonly valueMappings!: pulumi.Output<outputs.DashboardAlertlistChartValueMapping[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: DashboardAlertlistChartArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DashboardAlertlistChartArgs | DashboardAlertlistChartState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DashboardAlertlistChartState | undefined;
            resourceInputs["alertListType"] = state ? state.alertListType : undefined;
            ...
            resourceInputs["filterStatuses"] = state ? state.filterStatuses : undefined;
            ...
            const args = argsOrState as DashboardAlertlistChartArgs | undefined;
            ...
            resourceInputs["alertListType"] = args ? args.alertListType : undefined;
            ...
            resourceInputs["filterStatuses"] = args ? args.filterStatuses : undefined;
        ...
        super(DashboardAlertlistChart.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DashboardAlertlistChartState {
    /**
     * alert list type
     */
    alertListType?: pulumi.Input<string>;
    /**
     * chart traces to be included
     */
    chartItems?: pulumi.Input<pulumi.Input<inputs.DashboardAlertlistChartChartItem>[]>;
     ...
     * filter status list
     */
    filterStatuses?: pulumi.Input<pulumi.Input<string>[]>;
    /**
     * chart height in px
     */
     ...
     * optional static lines to be added to the chart as references
     */
    thresholds?: pulumi.Input<pulumi.Input<inputs.DashboardAlertlistChartThreshold>[]>;
    /**
     * date in isoformat or shortcut string where to end reading
     */
     ...
     * optional mappings to transform data with rules
     */
    valueMappings?: pulumi.Input<pulumi.Input<inputs.DashboardAlertlistChartValueMapping>[]>;
    /**
     * chart width in cols (max 20)
     */
 ...
 */
export interface DashboardAlertlistChartArgs {
    /**
     * alert list type
     */
    alertListType?: pulumi.Input<string>;
