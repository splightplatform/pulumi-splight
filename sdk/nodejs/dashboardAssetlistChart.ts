 ...
 * ```
 */
export class DashboardAssetlistChart extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DashboardAssetlistChartState, opts?: pulumi.CustomResourceOptions): DashboardAssetlistChart {
        return new DashboardAssetlistChart(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'splight:index/dashboardAssetlistChart:DashboardAssetlistChart';

    /**
     * Returns true if the given object is an instance of DashboardAssetlistChart.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DashboardAssetlistChart {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DashboardAssetlistChart.__pulumiType;
    }

    /**
     * asset list type
     */
    public readonly assetListType!: pulumi.Output<string | undefined>;
    /**
     * chart traces to be included
     */
    public readonly chartItems!: pulumi.Output<outputs.DashboardAssetlistChartChartItem[]>;
     ...
     */
    public readonly thresholds!: pulumi.Output<outputs.DashboardAssetlistChartThreshold[] | undefined>;
    /**
     ...
     */
    public readonly valueMappings!: pulumi.Output<outputs.DashboardAssetlistChartValueMapping[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: DashboardAssetlistChartArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DashboardAssetlistChartArgs | DashboardAssetlistChartState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DashboardAssetlistChartState | undefined;
            resourceInputs["assetListType"] = state ? state.assetListType : undefined;
            ...
            const args = argsOrState as DashboardAssetlistChartArgs | undefined;
            ...
            resourceInputs["assetListType"] = args ? args.assetListType : undefined;
        ...
        super(DashboardAssetlistChart.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DashboardAssetlistChartState {
    /**
     * asset list type
     */
    assetListType?: pulumi.Input<string>;
    /**
     * chart traces to be included
     */
    chartItems?: pulumi.Input<pulumi.Input<inputs.DashboardAssetlistChartChartItem>[]>;
     ...
     * optional static lines to be added to the chart as references
     */
    thresholds?: pulumi.Input<pulumi.Input<inputs.DashboardAssetlistChartThreshold>[]>;
    /**
     * date in isoformat or shortcut string where to end reading
     */
     ...
     * optional mappings to transform data with rules
     */
    valueMappings?: pulumi.Input<pulumi.Input<inputs.DashboardAssetlistChartValueMapping>[]>;
    /**
     * chart width in cols (max 20)
     */
 ...
 */
export interface DashboardAssetlistChartArgs {
    /**
     * asset list type
     */
    assetListType?: pulumi.Input<string>;
