 ...
 * ```
 */
export class DashboardTableChart extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DashboardTableChartState, opts?: pulumi.CustomResourceOptions): DashboardTableChart {
        return new DashboardTableChart(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'splight:index/dashboardTableChart:DashboardTableChart';

    /**
     * Returns true if the given object is an instance of DashboardTableChart.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DashboardTableChart {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DashboardTableChart.__pulumiType;
    }

    /**
     * chart traces to be included
     */
    public readonly chartItems!: pulumi.Output<outputs.DashboardTableChartChartItem[]>;
     ...
     */
    public readonly thresholds!: pulumi.Output<outputs.DashboardTableChartThreshold[] | undefined>;
    /**
     ...
     */
    public readonly valueMappings!: pulumi.Output<outputs.DashboardTableChartValueMapping[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: DashboardTableChartArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DashboardTableChartArgs | DashboardTableChartState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DashboardTableChartState | undefined;
            ...
            const args = argsOrState as DashboardTableChartArgs | undefined;
        ...
        super(DashboardTableChart.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DashboardTableChartState {
    /**
     * chart traces to be included
     */
    chartItems?: pulumi.Input<pulumi.Input<inputs.DashboardTableChartChartItem>[]>;
     ...
     * optional static lines to be added to the chart as references
     */
    thresholds?: pulumi.Input<pulumi.Input<inputs.DashboardTableChartThreshold>[]>;
    /**
     * date in isoformat or shortcut string where to end reading
     */
     ...
     * optional mappings to transform data with rules
     */
    valueMappings?: pulumi.Input<pulumi.Input<inputs.DashboardTableChartValueMapping>[]>;
    /**
     * chart width in cols (max 20)
     */
 ...
 */
export interface DashboardTableChartArgs {
    /**
     * chart traces to be included
     */
    chartItems: pulumi.Input<pulumi.Input<inputs.DashboardTableChartChartItem>[]>;
