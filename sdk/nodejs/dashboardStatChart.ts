 ...
 * ```
 */
export class DashboardStatChart extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DashboardStatChartState, opts?: pulumi.CustomResourceOptions): DashboardStatChart {
        return new DashboardStatChart(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'splight:index/dashboardStatChart:DashboardStatChart';

    /**
     * Returns true if the given object is an instance of DashboardStatChart.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DashboardStatChart {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DashboardStatChart.__pulumiType;
    }
     ...
     */
    public readonly chartItems!: pulumi.Output<outputs.DashboardStatChartChartItem[]>;
     ...
     */
    public readonly thresholds!: pulumi.Output<outputs.DashboardStatChartThreshold[] | undefined>;
    /**
     ...
     */
    public readonly valueMappings!: pulumi.Output<outputs.DashboardStatChartValueMapping[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: DashboardStatChartArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DashboardStatChartArgs | DashboardStatChartState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DashboardStatChartState | undefined;
            ...
            const args = argsOrState as DashboardStatChartArgs | undefined;
        ...
        super(DashboardStatChart.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DashboardStatChartState {
    /**
     * whether to show the border or not
     */
     ...
     * chart traces to be included
     */
    chartItems?: pulumi.Input<pulumi.Input<inputs.DashboardStatChartChartItem>[]>;
     ...
     * optional static lines to be added to the chart as references
     */
    thresholds?: pulumi.Input<pulumi.Input<inputs.DashboardStatChartThreshold>[]>;
    /**
     * date in isoformat or shortcut string where to end reading
     */
     ...
     * optional mappings to transform data with rules
     */
    valueMappings?: pulumi.Input<pulumi.Input<inputs.DashboardStatChartValueMapping>[]>;
    /**
     * chart width in cols (max 20)
     */
 ...
 */
export interface DashboardStatChartArgs {
    /**
     * whether to show the border or not
     */
    border?: pulumi.Input<boolean>;
