 ...
 * ```
 */
export class DashboardAlerteventsChart extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DashboardAlerteventsChartState, opts?: pulumi.CustomResourceOptions): DashboardAlerteventsChart {
        return new DashboardAlerteventsChart(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'splight:index/dashboardAlerteventsChart:DashboardAlerteventsChart';

    /**
     * Returns true if the given object is an instance of DashboardAlerteventsChart.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DashboardAlerteventsChart {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DashboardAlerteventsChart.__pulumiType;
    }

    /**
     * chart traces to be included
     */
    public readonly chartItems!: pulumi.Output<outputs.DashboardAlerteventsChartChartItem[]>;
     ...
     * filter new status
     */
    public readonly filterNewStatuses!: pulumi.Output<string[] | undefined>;
    /**
     * filter old status
     */
    public readonly filterOldStatuses!: pulumi.Output<string[] | undefined>;
    /**
     * chart height in px
     */
     ...
     */
    public readonly thresholds!: pulumi.Output<outputs.DashboardAlerteventsChartThreshold[] | undefined>;
    /**
     ...
     */
    public readonly valueMappings!: pulumi.Output<outputs.DashboardAlerteventsChartValueMapping[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: DashboardAlerteventsChartArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DashboardAlerteventsChartArgs | DashboardAlerteventsChartState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DashboardAlerteventsChartState | undefined;
            ...
            resourceInputs["filterNewStatuses"] = state ? state.filterNewStatuses : undefined;
            resourceInputs["filterOldStatuses"] = state ? state.filterOldStatuses : undefined;
            ...
            const args = argsOrState as DashboardAlerteventsChartArgs | undefined;
            ...
            resourceInputs["filterNewStatuses"] = args ? args.filterNewStatuses : undefined;
            resourceInputs["filterOldStatuses"] = args ? args.filterOldStatuses : undefined;
        ...
        super(DashboardAlerteventsChart.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DashboardAlerteventsChartState {
    /**
     * chart traces to be included
     */
    chartItems?: pulumi.Input<pulumi.Input<inputs.DashboardAlerteventsChartChartItem>[]>;
     ...
     * filter new status
     */
    filterNewStatuses?: pulumi.Input<pulumi.Input<string>[]>;
    /**
     * filter old status
     */
    filterOldStatuses?: pulumi.Input<pulumi.Input<string>[]>;
    /**
     * chart height in px
     */
     ...
     * optional static lines to be added to the chart as references
     */
    thresholds?: pulumi.Input<pulumi.Input<inputs.DashboardAlerteventsChartThreshold>[]>;
    /**
     * date in isoformat or shortcut string where to end reading
     */
     ...
     * optional mappings to transform data with rules
     */
    valueMappings?: pulumi.Input<pulumi.Input<inputs.DashboardAlerteventsChartValueMapping>[]>;
    /**
     * chart width in cols (max 20)
     */
 ...
 */
export interface DashboardAlerteventsChartArgs {
    /**
     * chart traces to be included
     */
    chartItems: pulumi.Input<pulumi.Input<inputs.DashboardAlerteventsChartChartItem>[]>;
