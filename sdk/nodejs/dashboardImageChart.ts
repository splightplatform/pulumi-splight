 ...
 * ```
 */
export class DashboardImageChart extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DashboardImageChartState, opts?: pulumi.CustomResourceOptions): DashboardImageChart {
        return new DashboardImageChart(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'splight:index/dashboardImageChart:DashboardImageChart';

    /**
     * Returns true if the given object is an instance of DashboardImageChart.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DashboardImageChart {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DashboardImageChart.__pulumiType;
    }

    /**
     * chart traces to be included
     */
    public readonly chartItems!: pulumi.Output<outputs.DashboardImageChartChartItem[]>;
     ...
     */
    public readonly thresholds!: pulumi.Output<outputs.DashboardImageChartThreshold[] | undefined>;
    /**
     ...
     */
    public readonly valueMappings!: pulumi.Output<outputs.DashboardImageChartValueMapping[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: DashboardImageChartArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DashboardImageChartArgs | DashboardImageChartState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DashboardImageChartState | undefined;
            ...
            const args = argsOrState as DashboardImageChartArgs | undefined;
        ...
        super(DashboardImageChart.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DashboardImageChartState {
    /**
     * chart traces to be included
     */
    chartItems?: pulumi.Input<pulumi.Input<inputs.DashboardImageChartChartItem>[]>;
     ...
     * optional static lines to be added to the chart as references
     */
    thresholds?: pulumi.Input<pulumi.Input<inputs.DashboardImageChartThreshold>[]>;
    /**
     * date in isoformat or shortcut string where to end reading
     */
     ...
     * optional mappings to transform data with rules
     */
    valueMappings?: pulumi.Input<pulumi.Input<inputs.DashboardImageChartValueMapping>[]>;
    /**
     * chart width in cols (max 20)
     */
 ...
 */
export interface DashboardImageChartArgs {
    /**
     * chart traces to be included
     */
    chartItems: pulumi.Input<pulumi.Input<inputs.DashboardImageChartChartItem>[]>;
