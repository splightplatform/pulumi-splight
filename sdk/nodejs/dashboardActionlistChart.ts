 ...
 * ```
 */
export class DashboardActionlistChart extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DashboardActionlistChartState, opts?: pulumi.CustomResourceOptions): DashboardActionlistChart {
        return new DashboardActionlistChart(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'splight:index/dashboardActionlistChart:DashboardActionlistChart';

    /**
     * Returns true if the given object is an instance of DashboardActionlistChart.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DashboardActionlistChart {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DashboardActionlistChart.__pulumiType;
    }

    /**
     * action list type
     */
    public readonly actionListType!: pulumi.Output<string | undefined>;
    /**
     * chart traces to be included
     */
    public readonly chartItems!: pulumi.Output<outputs.DashboardActionlistChartChartItem[]>;
     ...
     * filter asset name
     */
    public readonly filterAssetName!: pulumi.Output<string | undefined>;
    /**
     * filter name
     */
     ...
     */
    public readonly thresholds!: pulumi.Output<outputs.DashboardActionlistChartThreshold[] | undefined>;
    /**
     ...
     */
    public readonly valueMappings!: pulumi.Output<outputs.DashboardActionlistChartValueMapping[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: DashboardActionlistChartArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DashboardActionlistChartArgs | DashboardActionlistChartState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DashboardActionlistChartState | undefined;
            resourceInputs["actionListType"] = state ? state.actionListType : undefined;
            ...
            resourceInputs["filterAssetName"] = state ? state.filterAssetName : undefined;
            ...
            const args = argsOrState as DashboardActionlistChartArgs | undefined;
            ...
            resourceInputs["actionListType"] = args ? args.actionListType : undefined;
            ...
            resourceInputs["filterAssetName"] = args ? args.filterAssetName : undefined;
        ...
        super(DashboardActionlistChart.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DashboardActionlistChartState {
    /**
     * action list type
     */
    actionListType?: pulumi.Input<string>;
    /**
     * chart traces to be included
     */
    chartItems?: pulumi.Input<pulumi.Input<inputs.DashboardActionlistChartChartItem>[]>;
     ...
     * filter asset name
     */
    filterAssetName?: pulumi.Input<string>;
    /**
     * filter name
     */
     ...
     * optional static lines to be added to the chart as references
     */
    thresholds?: pulumi.Input<pulumi.Input<inputs.DashboardActionlistChartThreshold>[]>;
    /**
     * date in isoformat or shortcut string where to end reading
     */
     ...
     * optional mappings to transform data with rules
     */
    valueMappings?: pulumi.Input<pulumi.Input<inputs.DashboardActionlistChartValueMapping>[]>;
    /**
     * chart width in cols (max 20)
     */
 ...
 */
export interface DashboardActionlistChartArgs {
    /**
     * action list type
     */
    actionListType?: pulumi.Input<string>;
