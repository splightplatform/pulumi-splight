...
func NewNode(ctx *pulumi.Context,
	...
	var resource Node
	err := ctx.RegisterResource("splight:index/node:Node", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNode(ctx *pulumi.Context,
	...
	var resource Node
	err := ctx.ReadResource("splight:index/node:Node", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// intance type
func (o NodeOutput) InstanceType() pulumi.StringOutput {
	return o.ApplyT(func(v *Node) pulumi.StringOutput { return v.InstanceType }).(pulumi.StringOutput)
}
...
// organization id
func (o NodeOutput) OrganizationId() pulumi.StringOutput {
	return o.ApplyT(func(v *Node) pulumi.StringOutput { return v.OrganizationId }).(pulumi.StringOutput)
}
