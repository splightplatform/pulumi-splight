...
__all__ = ['DashboardBarChartArgs', 'DashboardBarChart']

@pulumi.input_type
class DashboardBarChartArgs:
    def __init__(__self__, *,
                 chart_items: pulumi.Input[Sequence[pulumi.Input['DashboardBarChartChartItemArgs']]],
                 ...
                 thresholds: Optional[pulumi.Input[Sequence[pulumi.Input['DashboardBarChartThresholdArgs']]]] = None,
                 timezone: Optional[pulumi.Input[str]] = None,
                 value_mappings: Optional[pulumi.Input[Sequence[pulumi.Input['DashboardBarChartValueMappingArgs']]]] = None,
                 width: Optional[pulumi.Input[int]] = None,
                 y_axis_unit: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a DashboardBarChart resource.
        :param pulumi.Input[Sequence[pulumi.Input['DashboardBarChartChartItemArgs']]] chart_items: chart traces to be included
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DashboardBarChartThresholdArgs']]] thresholds: optional static lines to be added to the chart as references
        :param pulumi.Input[str] timezone: chart timezone
        :param pulumi.Input[Sequence[pulumi.Input['DashboardBarChartValueMappingArgs']]] value_mappings: optional mappings to transform data with rules
    ...
    def chart_items(self) -> pulumi.Input[Sequence[pulumi.Input['DashboardBarChartChartItemArgs']]]:
        """
    ...
    @chart_items.setter
    def chart_items(self, value: pulumi.Input[Sequence[pulumi.Input['DashboardBarChartChartItemArgs']]]):
    ...
    @property
    @pulumi.getter
    def thresholds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DashboardBarChartThresholdArgs']]]]:
        """
    ...
    @thresholds.setter
    def thresholds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DashboardBarChartThresholdArgs']]]]):
    ...
    def value_mappings(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DashboardBarChartValueMappingArgs']]]]:
        """
    ...
    def value_mappings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DashboardBarChartValueMappingArgs']]]]):
...
@pulumi.input_type
class _DashboardBarChartState:
    def __init__(__self__, *,
                 chart_items: Optional[pulumi.Input[Sequence[pulumi.Input['DashboardBarChartChartItemArgs']]]] = None,
                 collection: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 display_time_range: Optional[pulumi.Input[bool]] = None,
                 height: Optional[pulumi.Input[int]] = None,
    ...
    @property
    @pulumi.getter(name="chartItems")
    def chart_items(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DashboardBarChartChartItemArgs']]]]:
        """
        chart traces to be included
        """
        return pulumi.get(self, "chart_items")
    ...
    @chart_items.setter
    def chart_items(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DashboardBarChartChartItemArgs']]]]):
        pulumi.set(self, "chart_items", value)
...
class DashboardBarChart(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 chart_items: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DashboardBarChartChartItemArgs', 'DashboardBarChartChartItemArgsDict']]]]] = None,
                 collection: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 display_time_range: Optional[pulumi.Input[bool]] = None,
                 height: Optional[pulumi.Input[int]] = None,
                 ...
                 show_beyond_data: Optional[pulumi.Input[bool]] = None,
                 tab: Optional[pulumi.Input[str]] = None,
                 thresholds: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DashboardBarChartThresholdArgs', 'DashboardBarChartThresholdArgsDict']]]]] = None,
                 timestamp_gte: Optional[pulumi.Input[str]] = None,
                 timestamp_lte: Optional[pulumi.Input[str]] = None,
                 timezone: Optional[pulumi.Input[str]] = None,
                 value_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DashboardBarChartValueMappingArgs', 'DashboardBarChartValueMappingArgsDict']]]]] = None,
                 width: Optional[pulumi.Input[int]] = None,
                 y_axis_unit: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['DashboardBarChartChartItemArgs', 'DashboardBarChartChartItemArgsDict']]]] chart_items: chart traces to be included
        :param pulumi.Input[str] description: chart description
        :param pulumi.Input[bool] display_time_range: whether to display the time range or not
        :param pulumi.Input[int] height: chart height in px
        :param pulumi.Input[str] labels_aggregation: [last|avg|...] aggregation
        ...
        :param pulumi.Input[bool] show_beyond_data: whether to show data which is beyond timestamp_lte or not
        :param pulumi.Input[str] tab: id for the tab where to place the chart
        :param pulumi.Input[Sequence[pulumi.Input[Union['DashboardBarChartThresholdArgs', 'DashboardBarChartThresholdArgsDict']]]] thresholds: optional static lines to be added to the chart as references
        :param pulumi.Input[str] timestamp_gte: date in isoformat or shortcut string where to end reading
        :param pulumi.Input[str] timestamp_lte: date in isoformat or shortcut string where to start reading
        :param pulumi.Input[str] timezone: chart timezone
        :param pulumi.Input[Sequence[pulumi.Input[Union['DashboardBarChartValueMappingArgs', 'DashboardBarChartValueMappingArgsDict']]]] value_mappings: optional mappings to transform data with rules
        :param pulumi.Input[int] width: chart width in cols (max 20)
        :param pulumi.Input[str] y_axis_unit: y axis units
        """
        ...
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DashboardBarChartArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DashboardBarChartArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DashboardBarChartArgs.__new__(DashboardBarChartArgs)
        ...
        super(DashboardBarChart, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            value_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DashboardBarChartValueMappingArgs', 'DashboardBarChartValueMappingArgsDict']]]]] = None,
            width: Optional[pulumi.Input[int]] = None,
            y_axis_unit: Optional[pulumi.Input[str]] = None) -> 'DashboardBarChart':
        """
        ...
        __props__ = _DashboardBarChartState.__new__(_DashboardBarChartState)
        ...
        __props__.__dict__["width"] = width
        __props__.__dict__["y_axis_unit"] = y_axis_unit
        return DashboardBarChart(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="chartItems")
    def chart_items(self) -> pulumi.Output[Sequence['outputs.DashboardBarChartChartItem']]:
        """
        chart traces to be included
        """
        return pulumi.get(self, "chart_items")
    ...
    @property
    @pulumi.getter
    def thresholds(self) -> pulumi.Output[Optional[Sequence['outputs.DashboardBarChartThreshold']]]:
        """
        optional static lines to be added to the chart as references
        """
        return pulumi.get(self, "thresholds")
    ...
    @property
    @pulumi.getter(name="valueMappings")
    def value_mappings(self) -> pulumi.Output[Optional[Sequence['outputs.DashboardBarChartValueMapping']]]:
        """
        optional mappings to transform data with rules
        """
        return pulumi.get(self, "value_mappings")
