...
class ComponentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] log_level: log level of the component
        ...
        :param pulumi.Input[str] node: id of the compute node where the component runs
        :param pulumi.Input[str] restart_policy: restart policy of the component
