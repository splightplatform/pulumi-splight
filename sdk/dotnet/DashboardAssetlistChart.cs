...
namespace Splight.Splight
{
    ...
    /// ```
    /// </summary>
    [SplightResourceType("splight:index/dashboardAssetlistChart:DashboardAssetlistChart")]
    public partial class DashboardAssetlistChart : global::Pulumi.CustomResource
    {
        /// <summary>
        /// asset list type
        /// </summary>
        [Output("assetListType")]
        public Output<string?> AssetListType { get; private set; } = null!;

        /// <summary>
        /// chart traces to be included
        /// </summary>
        [Output("chartItems")]
        public Output<ImmutableArray<Outputs.DashboardAssetlistChartChartItem>> ChartItems { get; private set; } = null!;
        ...
        /// </summary>
        [Output("thresholds")]
        public Output<ImmutableArray<Outputs.DashboardAssetlistChartThreshold>> Thresholds { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.DashboardAssetlistChartValueMapping>> ValueMappings { get; private set; } = null!;
        ...
        /// <summary>
        /// Create a DashboardAssetlistChart resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public DashboardAssetlistChart(string name, DashboardAssetlistChartArgs args, CustomResourceOptions? options = null)
            : base("splight:index/dashboardAssetlistChart:DashboardAssetlistChart", name, args ?? new DashboardAssetlistChartArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DashboardAssetlistChart(string name, Input<string> id, DashboardAssetlistChartState? state = null, CustomResourceOptions? options = null)
            : base("splight:index/dashboardAssetlistChart:DashboardAssetlistChart", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DashboardAssetlistChart Get(string name, Input<string> id, DashboardAssetlistChartState? state = null, CustomResourceOptions? options = null)
        {
            return new DashboardAssetlistChart(name, id, state, options);
        }
    }

    public sealed class DashboardAssetlistChartArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// asset list type
        /// </summary>
        [Input("assetListType")]
        public Input<string>? AssetListType { get; set; }

        [Input("chartItems", required: true)]
        private InputList<Inputs.DashboardAssetlistChartChartItemArgs>? _chartItems;

        /// <summary>
        /// chart traces to be included
        /// </summary>
        public InputList<Inputs.DashboardAssetlistChartChartItemArgs> ChartItems
        {
            get => _chartItems ?? (_chartItems = new InputList<Inputs.DashboardAssetlistChartChartItemArgs>());
        ...
        [Input("thresholds")]
        private InputList<Inputs.DashboardAssetlistChartThresholdArgs>? _thresholds;

        /// <summary>
        /// optional static lines to be added to the chart as references
        /// </summary>
        public InputList<Inputs.DashboardAssetlistChartThresholdArgs> Thresholds
        {
            get => _thresholds ?? (_thresholds = new InputList<Inputs.DashboardAssetlistChartThresholdArgs>());
        ...
        [Input("valueMappings")]
        private InputList<Inputs.DashboardAssetlistChartValueMappingArgs>? _valueMappings;

        /// <summary>
        /// optional mappings to transform data with rules
        /// </summary>
        public InputList<Inputs.DashboardAssetlistChartValueMappingArgs> ValueMappings
        {
            get => _valueMappings ?? (_valueMappings = new InputList<Inputs.DashboardAssetlistChartValueMappingArgs>());
        ...
        public DashboardAssetlistChartArgs()
        {
        }
        public static new DashboardAssetlistChartArgs Empty => new DashboardAssetlistChartArgs();
    }

    public sealed class DashboardAssetlistChartState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// asset list type
        /// </summary>
        ...
        [Input("chartItems")]
        private InputList<Inputs.DashboardAssetlistChartChartItemGetArgs>? _chartItems;

        /// <summary>
        /// chart traces to be included
        /// </summary>
        public InputList<Inputs.DashboardAssetlistChartChartItemGetArgs> ChartItems
        {
            get => _chartItems ?? (_chartItems = new InputList<Inputs.DashboardAssetlistChartChartItemGetArgs>());
            set => _chartItems = value;
        }
        ...
        [Input("thresholds")]
        private InputList<Inputs.DashboardAssetlistChartThresholdGetArgs>? _thresholds;

        /// <summary>
        /// optional static lines to be added to the chart as references
        /// </summary>
        public InputList<Inputs.DashboardAssetlistChartThresholdGetArgs> Thresholds
        {
            get => _thresholds ?? (_thresholds = new InputList<Inputs.DashboardAssetlistChartThresholdGetArgs>());
            set => _thresholds = value;
        }
        ...
        [Input("valueMappings")]
        private InputList<Inputs.DashboardAssetlistChartValueMappingGetArgs>? _valueMappings;

        /// <summary>
        /// optional mappings to transform data with rules
        /// </summary>
        public InputList<Inputs.DashboardAssetlistChartValueMappingGetArgs> ValueMappings
        {
            get => _valueMappings ?? (_valueMappings = new InputList<Inputs.DashboardAssetlistChartValueMappingGetArgs>());
            set => _valueMappings = value;
        }
        ...
        public DashboardAssetlistChartState()
        {
        }
        public static new DashboardAssetlistChartState Empty => new DashboardAssetlistChartState();
    }
}
