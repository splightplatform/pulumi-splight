...
namespace Splight.Splight.Inputs
{
    ...
    public sealed class DashboardAlerteventsChartChartItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DashboardAlerteventsChartChartItemQueryFilterAssetArgs> QueryFilterAsset { get; set; } = null!;

        /// <summary>
        /// Asset/Attribute filter
        /// </summary>
        [Input("queryFilterAttribute", required: true)]
        public Input<Inputs.DashboardAlerteventsChartChartItemQueryFilterAttributeArgs> QueryFilterAttribute { get; set; } = null!;
        ...
        public DashboardAlerteventsChartChartItemArgs()
        {
        }
        public static new DashboardAlerteventsChartChartItemArgs Empty => new DashboardAlerteventsChartChartItemArgs();
    }
}
