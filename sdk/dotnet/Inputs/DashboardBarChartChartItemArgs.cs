...
namespace Splight.Splight.Inputs
{
    ...
    public sealed class DashboardBarChartChartItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DashboardBarChartChartItemQueryFilterAssetArgs> QueryFilterAsset { get; set; } = null!;

        /// <summary>
        /// Asset/Attribute filter
        /// </summary>
        [Input("queryFilterAttribute", required: true)]
        public Input<Inputs.DashboardBarChartChartItemQueryFilterAttributeArgs> QueryFilterAttribute { get; set; } = null!;
        ...
        public DashboardBarChartChartItemArgs()
        {
        }
        public static new DashboardBarChartChartItemArgs Empty => new DashboardBarChartChartItemArgs();
    }
}
