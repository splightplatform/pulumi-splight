...
namespace Splight.Splight.Inputs
{
    ...
    public sealed class DashboardActionlistChartChartItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DashboardActionlistChartChartItemQueryFilterAssetArgs> QueryFilterAsset { get; set; } = null!;

        /// <summary>
        /// Attribute filter
        /// </summary>
        [Input("queryFilterAttribute", required: true)]
        public Input<Inputs.DashboardActionlistChartChartItemQueryFilterAttributeArgs> QueryFilterAttribute { get; set; } = null!;
        ...
        public DashboardActionlistChartChartItemArgs()
        {
        }
        public static new DashboardActionlistChartChartItemArgs Empty => new DashboardActionlistChartChartItemArgs();
    }
}
