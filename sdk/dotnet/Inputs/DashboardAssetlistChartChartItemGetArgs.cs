...
namespace Splight.Splight.Inputs
{
    ...
    public sealed class DashboardAssetlistChartChartItemGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DashboardAssetlistChartChartItemQueryFilterAssetGetArgs> QueryFilterAsset { get; set; } = null!;

        /// <summary>
        /// Attribute filter
        /// </summary>
        [Input("queryFilterAttribute", required: true)]
        public Input<Inputs.DashboardAssetlistChartChartItemQueryFilterAttributeGetArgs> QueryFilterAttribute { get; set; } = null!;
        ...
        public DashboardAssetlistChartChartItemGetArgs()
        {
        }
        public static new DashboardAssetlistChartChartItemGetArgs Empty => new DashboardAssetlistChartChartItemGetArgs();
    }
}
