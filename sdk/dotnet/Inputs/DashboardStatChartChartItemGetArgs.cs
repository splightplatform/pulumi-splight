...
namespace Splight.Splight.Inputs
{
    ...
    public sealed class DashboardStatChartChartItemGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DashboardStatChartChartItemQueryFilterAssetGetArgs> QueryFilterAsset { get; set; } = null!;

        /// <summary>
        /// Attribute filter
        /// </summary>
        [Input("queryFilterAttribute", required: true)]
        public Input<Inputs.DashboardStatChartChartItemQueryFilterAttributeGetArgs> QueryFilterAttribute { get; set; } = null!;
        ...
        public DashboardStatChartChartItemGetArgs()
        {
        }
        public static new DashboardStatChartChartItemGetArgs Empty => new DashboardStatChartChartItemGetArgs();
    }
}
