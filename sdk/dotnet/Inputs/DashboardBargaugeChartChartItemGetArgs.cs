...
namespace Splight.Splight.Inputs
{
    ...
    public sealed class DashboardBargaugeChartChartItemGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DashboardBargaugeChartChartItemQueryFilterAssetGetArgs> QueryFilterAsset { get; set; } = null!;

        /// <summary>
        /// Asset/Attribute filter
        /// </summary>
        [Input("queryFilterAttribute", required: true)]
        public Input<Inputs.DashboardBargaugeChartChartItemQueryFilterAttributeGetArgs> QueryFilterAttribute { get; set; } = null!;
        ...
        public DashboardBargaugeChartChartItemGetArgs()
        {
        }
        public static new DashboardBargaugeChartChartItemGetArgs Empty => new DashboardBargaugeChartChartItemGetArgs();
    }
}
