...
namespace Splight.Splight.Inputs
{
    ...
    public sealed class DashboardTimeseriesChartChartItemGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DashboardTimeseriesChartChartItemQueryFilterAssetGetArgs> QueryFilterAsset { get; set; } = null!;

        /// <summary>
        /// Asset/Attribute filter
        /// </summary>
        [Input("queryFilterAttribute", required: true)]
        public Input<Inputs.DashboardTimeseriesChartChartItemQueryFilterAttributeGetArgs> QueryFilterAttribute { get; set; } = null!;
        ...
        public DashboardTimeseriesChartChartItemGetArgs()
        {
        }
        public static new DashboardTimeseriesChartChartItemGetArgs Empty => new DashboardTimeseriesChartChartItemGetArgs();
    }
}
