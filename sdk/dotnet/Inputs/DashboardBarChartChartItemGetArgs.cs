...
namespace Splight.Splight.Inputs
{
    ...
    public sealed class DashboardBarChartChartItemGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DashboardBarChartChartItemQueryFilterAssetGetArgs> QueryFilterAsset { get; set; } = null!;

        /// <summary>
        /// Attribute filter
        /// </summary>
        [Input("queryFilterAttribute", required: true)]
        public Input<Inputs.DashboardBarChartChartItemQueryFilterAttributeGetArgs> QueryFilterAttribute { get; set; } = null!;
        ...
        public DashboardBarChartChartItemGetArgs()
        {
        }
        public static new DashboardBarChartChartItemGetArgs Empty => new DashboardBarChartChartItemGetArgs();
    }
}
