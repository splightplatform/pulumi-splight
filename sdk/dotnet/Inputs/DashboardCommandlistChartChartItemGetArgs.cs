...
namespace Splight.Splight.Inputs
{
    ...
    public sealed class DashboardCommandlistChartChartItemGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DashboardCommandlistChartChartItemQueryFilterAssetGetArgs> QueryFilterAsset { get; set; } = null!;

        /// <summary>
        /// Attribute filter
        /// </summary>
        [Input("queryFilterAttribute", required: true)]
        public Input<Inputs.DashboardCommandlistChartChartItemQueryFilterAttributeGetArgs> QueryFilterAttribute { get; set; } = null!;
        ...
        public DashboardCommandlistChartChartItemGetArgs()
        {
        }
        public static new DashboardCommandlistChartChartItemGetArgs Empty => new DashboardCommandlistChartChartItemGetArgs();
    }
}
