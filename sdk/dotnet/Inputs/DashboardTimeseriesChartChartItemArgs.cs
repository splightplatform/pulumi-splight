...
namespace Splight.Splight.Inputs
{
    ...
    public sealed class DashboardTimeseriesChartChartItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DashboardTimeseriesChartChartItemQueryFilterAssetArgs> QueryFilterAsset { get; set; } = null!;

        /// <summary>
        /// Attribute filter
        /// </summary>
        [Input("queryFilterAttribute", required: true)]
        public Input<Inputs.DashboardTimeseriesChartChartItemQueryFilterAttributeArgs> QueryFilterAttribute { get; set; } = null!;
        ...
        public DashboardTimeseriesChartChartItemArgs()
        {
        }
        public static new DashboardTimeseriesChartChartItemArgs Empty => new DashboardTimeseriesChartChartItemArgs();
    }
}
