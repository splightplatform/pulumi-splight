...
namespace Splight.Splight.Inputs
{
    ...
    public sealed class DashboardStatChartChartItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DashboardStatChartChartItemQueryFilterAssetArgs> QueryFilterAsset { get; set; } = null!;

        /// <summary>
        /// Asset/Attribute filter
        /// </summary>
        [Input("queryFilterAttribute", required: true)]
        public Input<Inputs.DashboardStatChartChartItemQueryFilterAttributeArgs> QueryFilterAttribute { get; set; } = null!;
        ...
        public DashboardStatChartChartItemArgs()
        {
        }
        public static new DashboardStatChartChartItemArgs Empty => new DashboardStatChartChartItemArgs();
    }
}
