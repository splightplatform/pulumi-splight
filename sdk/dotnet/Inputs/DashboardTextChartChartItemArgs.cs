...
namespace Splight.Splight.Inputs
{
    ...
    public sealed class DashboardTextChartChartItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DashboardTextChartChartItemQueryFilterAssetArgs> QueryFilterAsset { get; set; } = null!;

        /// <summary>
        /// Asset/Attribute filter
        /// </summary>
        [Input("queryFilterAttribute", required: true)]
        public Input<Inputs.DashboardTextChartChartItemQueryFilterAttributeArgs> QueryFilterAttribute { get; set; } = null!;
        ...
        public DashboardTextChartChartItemArgs()
        {
        }
        public static new DashboardTextChartChartItemArgs Empty => new DashboardTextChartChartItemArgs();
    }
}
