...
namespace Splight.Splight.Inputs
{
    ...
    public sealed class DashboardCommandlistChartChartItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DashboardCommandlistChartChartItemQueryFilterAssetArgs> QueryFilterAsset { get; set; } = null!;

        /// <summary>
        /// Attribute filter
        /// </summary>
        [Input("queryFilterAttribute", required: true)]
        public Input<Inputs.DashboardCommandlistChartChartItemQueryFilterAttributeArgs> QueryFilterAttribute { get; set; } = null!;
        ...
        public DashboardCommandlistChartChartItemArgs()
        {
        }
        public static new DashboardCommandlistChartChartItemArgs Empty => new DashboardCommandlistChartChartItemArgs();
    }
}
