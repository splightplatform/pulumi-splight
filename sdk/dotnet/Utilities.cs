...
namespace Splight.Splight
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/splightplatform";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Splight.Splight.version.txt");
    ...
    internal sealed class SplightResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SplightResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
