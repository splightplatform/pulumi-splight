...
namespace Splight.Splight
{
    ...
    /// ```
    /// </summary>
    [SplightResourceType("splight:index/dashboardBarChart:DashboardBarChart")]
    public partial class DashboardBarChart : global::Pulumi.CustomResource
    {
        /// <summary>
        /// chart traces to be included
        /// </summary>
        [Output("chartItems")]
        public Output<ImmutableArray<Outputs.DashboardBarChartChartItem>> ChartItems { get; private set; } = null!;
        ...
        /// </summary>
        [Output("thresholds")]
        public Output<ImmutableArray<Outputs.DashboardBarChartThreshold>> Thresholds { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.DashboardBarChartValueMapping>> ValueMappings { get; private set; } = null!;
        ...
        public DashboardBarChart(string name, DashboardBarChartArgs args, CustomResourceOptions? options = null)
            : base("splight:index/dashboardBarChart:DashboardBarChart", name, args ?? new DashboardBarChartArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DashboardBarChart(string name, Input<string> id, DashboardBarChartState? state = null, CustomResourceOptions? options = null)
            : base("splight:index/dashboardBarChart:DashboardBarChart", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DashboardBarChart Get(string name, Input<string> id, DashboardBarChartState? state = null, CustomResourceOptions? options = null)
        {
            return new DashboardBarChart(name, id, state, options);
        }
    }

    public sealed class DashboardBarChartArgs : global::Pulumi.ResourceArgs
    {
        [Input("chartItems", required: true)]
        private InputList<Inputs.DashboardBarChartChartItemArgs>? _chartItems;

        /// <summary>
        /// chart traces to be included
        /// </summary>
        public InputList<Inputs.DashboardBarChartChartItemArgs> ChartItems
        {
            get => _chartItems ?? (_chartItems = new InputList<Inputs.DashboardBarChartChartItemArgs>());
        ...
        [Input("thresholds")]
        private InputList<Inputs.DashboardBarChartThresholdArgs>? _thresholds;

        /// <summary>
        /// optional static lines to be added to the chart as references
        /// </summary>
        public InputList<Inputs.DashboardBarChartThresholdArgs> Thresholds
        {
            get => _thresholds ?? (_thresholds = new InputList<Inputs.DashboardBarChartThresholdArgs>());
        ...
        [Input("valueMappings")]
        private InputList<Inputs.DashboardBarChartValueMappingArgs>? _valueMappings;

        /// <summary>
        /// optional mappings to transform data with rules
        /// </summary>
        public InputList<Inputs.DashboardBarChartValueMappingArgs> ValueMappings
        {
            get => _valueMappings ?? (_valueMappings = new InputList<Inputs.DashboardBarChartValueMappingArgs>());
        ...
        public DashboardBarChartArgs()
        {
        }
        public static new DashboardBarChartArgs Empty => new DashboardBarChartArgs();
    }

    public sealed class DashboardBarChartState : global::Pulumi.ResourceArgs
    {
        [Input("chartItems")]
        private InputList<Inputs.DashboardBarChartChartItemGetArgs>? _chartItems;

        /// <summary>
        /// chart traces to be included
        /// </summary>
        public InputList<Inputs.DashboardBarChartChartItemGetArgs> ChartItems
        {
            get => _chartItems ?? (_chartItems = new InputList<Inputs.DashboardBarChartChartItemGetArgs>());
            set => _chartItems = value;
        }
        ...
        [Input("thresholds")]
        private InputList<Inputs.DashboardBarChartThresholdGetArgs>? _thresholds;

        /// <summary>
        /// optional static lines to be added to the chart as references
        /// </summary>
        public InputList<Inputs.DashboardBarChartThresholdGetArgs> Thresholds
        {
            get => _thresholds ?? (_thresholds = new InputList<Inputs.DashboardBarChartThresholdGetArgs>());
            set => _thresholds = value;
        }
        ...
        [Input("valueMappings")]
        private InputList<Inputs.DashboardBarChartValueMappingGetArgs>? _valueMappings;

        /// <summary>
        /// optional mappings to transform data with rules
        /// </summary>
        public InputList<Inputs.DashboardBarChartValueMappingGetArgs> ValueMappings
        {
            get => _valueMappings ?? (_valueMappings = new InputList<Inputs.DashboardBarChartValueMappingGetArgs>());
            set => _valueMappings = value;
        }
        ...
        public DashboardBarChartState()
        {
        }
        public static new DashboardBarChartState Empty => new DashboardBarChartState();
    }
}
