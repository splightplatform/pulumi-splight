...
namespace Splight.Splight
{
    ...
    /// ```
    /// </summary>
    [SplightResourceType("splight:index/dashboardGaugeChart:DashboardGaugeChart")]
    public partial class DashboardGaugeChart : global::Pulumi.CustomResource
    {
        /// <summary>
        /// chart traces to be included
        /// </summary>
        [Output("chartItems")]
        public Output<ImmutableArray<Outputs.DashboardGaugeChartChartItem>> ChartItems { get; private set; } = null!;
        ...
        /// </summary>
        [Output("thresholds")]
        public Output<ImmutableArray<Outputs.DashboardGaugeChartThreshold>> Thresholds { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.DashboardGaugeChartValueMapping>> ValueMappings { get; private set; } = null!;
        ...
        public DashboardGaugeChart(string name, DashboardGaugeChartArgs args, CustomResourceOptions? options = null)
            : base("splight:index/dashboardGaugeChart:DashboardGaugeChart", name, args ?? new DashboardGaugeChartArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DashboardGaugeChart(string name, Input<string> id, DashboardGaugeChartState? state = null, CustomResourceOptions? options = null)
            : base("splight:index/dashboardGaugeChart:DashboardGaugeChart", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DashboardGaugeChart Get(string name, Input<string> id, DashboardGaugeChartState? state = null, CustomResourceOptions? options = null)
        {
            return new DashboardGaugeChart(name, id, state, options);
        }
    }

    public sealed class DashboardGaugeChartArgs : global::Pulumi.ResourceArgs
    {
        [Input("chartItems", required: true)]
        private InputList<Inputs.DashboardGaugeChartChartItemArgs>? _chartItems;

        /// <summary>
        /// chart traces to be included
        /// </summary>
        public InputList<Inputs.DashboardGaugeChartChartItemArgs> ChartItems
        {
            get => _chartItems ?? (_chartItems = new InputList<Inputs.DashboardGaugeChartChartItemArgs>());
        ...
        [Input("thresholds")]
        private InputList<Inputs.DashboardGaugeChartThresholdArgs>? _thresholds;

        /// <summary>
        /// optional static lines to be added to the chart as references
        /// </summary>
        public InputList<Inputs.DashboardGaugeChartThresholdArgs> Thresholds
        {
            get => _thresholds ?? (_thresholds = new InputList<Inputs.DashboardGaugeChartThresholdArgs>());
        ...
        [Input("valueMappings")]
        private InputList<Inputs.DashboardGaugeChartValueMappingArgs>? _valueMappings;

        /// <summary>
        /// optional mappings to transform data with rules
        /// </summary>
        public InputList<Inputs.DashboardGaugeChartValueMappingArgs> ValueMappings
        {
            get => _valueMappings ?? (_valueMappings = new InputList<Inputs.DashboardGaugeChartValueMappingArgs>());
        ...
        public DashboardGaugeChartArgs()
        {
        }
        public static new DashboardGaugeChartArgs Empty => new DashboardGaugeChartArgs();
    }

    public sealed class DashboardGaugeChartState : global::Pulumi.ResourceArgs
    {
        [Input("chartItems")]
        private InputList<Inputs.DashboardGaugeChartChartItemGetArgs>? _chartItems;

        /// <summary>
        /// chart traces to be included
        /// </summary>
        public InputList<Inputs.DashboardGaugeChartChartItemGetArgs> ChartItems
        {
            get => _chartItems ?? (_chartItems = new InputList<Inputs.DashboardGaugeChartChartItemGetArgs>());
            set => _chartItems = value;
        }
        ...
        [Input("thresholds")]
        private InputList<Inputs.DashboardGaugeChartThresholdGetArgs>? _thresholds;

        /// <summary>
        /// optional static lines to be added to the chart as references
        /// </summary>
        public InputList<Inputs.DashboardGaugeChartThresholdGetArgs> Thresholds
        {
            get => _thresholds ?? (_thresholds = new InputList<Inputs.DashboardGaugeChartThresholdGetArgs>());
            set => _thresholds = value;
        }
        ...
        [Input("valueMappings")]
        private InputList<Inputs.DashboardGaugeChartValueMappingGetArgs>? _valueMappings;

        /// <summary>
        /// optional mappings to transform data with rules
        /// </summary>
        public InputList<Inputs.DashboardGaugeChartValueMappingGetArgs> ValueMappings
        {
            get => _valueMappings ?? (_valueMappings = new InputList<Inputs.DashboardGaugeChartValueMappingGetArgs>());
            set => _valueMappings = value;
        }
        ...
        public DashboardGaugeChartState()
        {
        }
        public static new DashboardGaugeChartState Empty => new DashboardGaugeChartState();
    }
}
