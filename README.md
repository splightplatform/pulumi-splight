...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `splight` with the `NAME` of your provider.
   - find and replace all instances of the boilerplate `splight` with the `ORG` of your provider.
   - replace all instances of the `github.com/splightplatform/pulumi-splight` repository with the `REPOSITORY` location
...
- binary: pulumi-resource-splight
  ...
  ignore: []
  ldflags:
  - -X github.com/splightplatform/pulumi-splight/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-splight_darwin_amd64_v1
│   └── pulumi-resource-splight
├── pulumi-splight_darwin_arm64
│   └── pulumi-resource-splight
├── pulumi-splight_linux_amd64_v1
│   └── pulumi-resource-splight
├── pulumi-splight_linux_arm64
│   └── pulumi-resource-splight
├── pulumi-splight_windows_amd64_v1
│   └── pulumi-resource-splight.exe
└── pulumi-splight_windows_arm64
    └── pulumi-resource-splight.exe
```
